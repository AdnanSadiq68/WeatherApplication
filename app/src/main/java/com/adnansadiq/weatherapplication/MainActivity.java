...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            // we can get our weather information by city name by using intent (last)
    ...
    public void getWeatherData(double lat,double lon)
    {
        ...
        Call<WeatherMap> call = weatherAPI.getWeatherWithLocation(lat, lon);

        // enqueue method will allow us to retrive the data in the background
